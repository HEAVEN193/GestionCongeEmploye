...
<body>
    ...
    <h1>Ajouter un nouvau departement</h1>
 

    <form action="/newDepartement" method="POST">
        ...
        <select id="manager" name="manager" required>
            ...
            <?php foreach ($managers as $manager): ?>
                <option value="<?=  $manager->idEmploye ?>"><?=  $manager->Pseudo ?></option>
            <?php endforeach; ?>
        </select><br><br>
        ...
        <a href="/departement-manage-page" class="btn btn-secondary" style="margin-left: 10px;">Annuler</a>
